...
namespace Microsoft.OData.Service.Sample.Tests
{
	public class TrippinE2ETestCases : TrippinE2ETestBase
	{
		...
		public void PostReturnBadRequestStatusWithSeviceValidationMessage()
		{
			...
			// fix localization error  - in "ru-RU" culture the message is [{"Id":"System.ComponentModel.DataAnnotations.MinLengthAttribute","Message":"Поле LastName должно иметь тип строки или массива с минимальной длиной \"1\".","PropertyName":"LastName","Severity":"Error"}]
			Assert.Contains(
